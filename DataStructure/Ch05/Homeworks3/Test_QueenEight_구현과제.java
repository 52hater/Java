package DataStructure.Ch05.Homeworks3;
...
public class Test_QueenEight_구현과제 {
	public static void EightQueen(int[][] d) throws DataStructure.Ch05.Homeworks3.Stack4.EmptyGenericStackException {
		int count = 0;// 퀸 배치 갯수
	...
	public static void main(String[] args) throws DataStructure.Ch05.Homeworks3.Stack4.EmptyGenericStackException {
		int row = 8, col = 8;
